...
//		String request = "command=ban_user&login=—Єма&signIn=BAN"; // ban User
...
//		String request1 = "command=EDIT_ORDER_BOOKS_LIST&ACTION_COMMAND=Add_book&B_ID=4"; //edit orderBooksList буду добавл€ть по одной книге
//		String request2 = "command=EDIT_ORDER_BOOKS_LIST&ACTION_COMMAND=Add_book&B_ID=4"; //edit orderBooksList буду добавл€ть по одной книге
//		String request3 = "command=EDIT_ORDER_BOOKS_LIST&ACTION_COMMAND=remove_book&B_ID=5"; //edit orderBooksList буду добавл€ть по одной книге
//		String request4 = "command=EDIT_ORDER_BOOKS_LIST&ACTION_COMMAND=remove_book&B_ID=6"; //edit orderBooksList буду добавл€ть по одной книге
//		String request3 = "command=ADD_SUBSCRIPTION&"; //subscription будем добавл€ть в базу данных
//		String request4 = "command=REMOVE_SUBSCRIPTION&U_ID=3&B_ID=6"; //subscription будем добавл€ть в базу данных
